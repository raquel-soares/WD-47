; (function () {
    ...
    window.adicionaCartaoNoMural = function (cartaoObj) {
        ...
        const cartao = $(`
    <article id="cartao_${numeroDoCartao}" tabindex="0" style="background-color:${cartaoObj.cor}"	
            class="cartao">								
                <div class="opcoesDoCartao">
            <button	
                class="opcoesDoCartao-remove opcoesDoCartao-opcao" tabindex="0">																
            ...
            <label	for="corTarefa-cartao${numeroDoCartao}"	class="opcoesDoCartao-tipo	opcoesDoCartao-opcao"
    ...
    $.ajax({
        ...
        , method: "GET"
        , data: {usuario: "raquel.hamdan@gmail.com.br"}
        , dataType: "jsonp"
